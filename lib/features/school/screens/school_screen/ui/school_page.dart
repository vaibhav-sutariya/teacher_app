                                    ...
                                    onTap: () {
                                      if (module.id == 'fees') {
                                        context.router.push(const FeesRoute());
                                          ...
                                          'staff_attendance') {
                                        context.router.push(
                                          const StaffAttendanceRoute(),
                                        );
                                      } else if (module.id == 'staff_details') {
                                        context.router.push(
                                          const StaffDetailsRoute(),
                                        );
                                      } else if (module.id == 'notice') {
                                        context.router.push(
                                          const NoticeCircularsRoute(),
                                        );
                                      } else if (module.id == 'enquiry') {
                                        context.router.push(
                                          const EnquiryRoute(),
                                        );
                                      } else if (module.id == 'strength') {
                                        context.router.push(
                                          const SchoolStrengthRoute(),
                                        );
                                      } else if (module.id == 'bus') {
                                        context.router.push(
                                          const BusTrackingRoute(),
                                        );
                                      }
                                    },
                                  );
