...
class StaffDetailsBloc extends Bloc<StaffDetailsEvent, StaffDetailsState> {
  StaffDetailsBloc()
    : super(const StaffDetailsState(status: StaffDetailsStatus.initial)) {
  ...
  void _onSearchStaff(SearchStaff event, Emitter<StaffDetailsState> emit) {
    ...
    final filtered = state.originalList
        .where(
          (staff) =>
              ...
              staff.designation.toLowerCase().contains(
