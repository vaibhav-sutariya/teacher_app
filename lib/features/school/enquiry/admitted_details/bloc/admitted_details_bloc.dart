...
class AdmittedDetailsBloc extends Bloc<AdmittedDetailsEvent, AdmittedDetailsState> {
  AdmittedDetailsBloc() : super(AdmittedDetailsInitial()) {
    on<LoadAdmittedDetails>(_onLoadDetails);
  }

  Future<void> _onLoadDetails(LoadAdmittedDetails event, Emitter<AdmittedDetailsState> emit) async {
