...
class StaffAttendanceHistoryBloc extends Bloc<StaffAttendanceHistoryEvent, StaffAttendanceHistoryState> {
  final StaffMember staff;
  
  StaffAttendanceHistoryBloc(this.staff) : super(StaffAttendanceHistoryState(
  ...
  Future<void> _onLoadHistory(
    ...
    try {
      ...
      emit(state.copyWith(
        status: StaffAttendanceHistoryStatus.loaded,
        logs: logs,
      ));
    } catch (e) {
      emit(state.copyWith(
