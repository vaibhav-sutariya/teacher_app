...
class SchoolStrengthBloc extends Bloc<SchoolStrengthEvent, SchoolStrengthState> {
  SchoolStrengthBloc() : super(SchoolStrengthInitial()) {
    on<LoadSchoolStrength>(_onLoadStrength);
  }

  Future<void> _onLoadStrength(LoadSchoolStrength event, Emitter<SchoolStrengthState> emit) async {
