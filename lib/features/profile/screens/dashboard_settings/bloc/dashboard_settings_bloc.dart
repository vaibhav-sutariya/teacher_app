...
class DashboardSettingsLoaded extends DashboardSettingsState {
  ...
  DashboardSettingsLoaded copyWith({List<DashboardSettingItem>? settings}) {
    return DashboardSettingsLoaded(settings: settings ?? this.settings);
  }
...
// --- Bloc ---
class DashboardSettingsBloc
    extends Bloc<DashboardSettingsEvent, DashboardSettingsState> {
