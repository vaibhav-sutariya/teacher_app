    ...
    return BlocSelector<AddPaperBloc, AddPaperState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) => context.read<AddPaperBloc>().add(UpdatePaperClassEvent(val!)),
        );
      },
    );
  }
    ...
    return BlocSelector<AddPaperBloc, AddPaperState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          items: const ['A', 'B', 'C'],
          itemLabel: (item) => item,
          onChanged: (val) => context.read<AddPaperBloc>().add(UpdatePaperSectionEvent(val!)),
        );
      },
    );
  }
    ...
    return BlocSelector<AddPaperBloc, AddPaperState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) => context.read<AddPaperBloc>().add(UpdatePaperSubjectEvent(val!)),
        );
      },
    );
  }
    ...
    return BlocSelector<AddPaperBloc, AddPaperState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) => context.read<AddPaperBloc>().add(UpdatePaperNameEvent(val!)),
        );
      },
    );
  }
        ...
        return Column(
          ...
          children: [
            AppDashedUploadButton(
              ...
              label: isUploaded ? 'Exam Paper Uploaded' : 'Upload Exam Paper PDF*',
              onTap: () {
                context.read<AddPaperBloc>().add(
                  const UpdatePaperPdfUrlEvent('https://www.aeee.in/wp-content/uploads/2020/08/Sample-pdf.pdf'),
                );
                ScaffoldMessenger.of(context).showSnackBar(
            ...
            child: BlocSelector<AddPaperBloc, AddPaperState, bool>(
              ...
              builder: (context, isLoading) {
                return AppPrimaryButton(
                  text: 'SAVE PAPER',
                  isLoading: isLoading,
                  onPressed: () => context.read<AddPaperBloc>().add(SubmitPaperEvent()),
                );
              },
            ),
          ),
