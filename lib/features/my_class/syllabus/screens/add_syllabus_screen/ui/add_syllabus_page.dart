    ...
    return BlocSelector<AddSyllabusBloc, AddSyllabusState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) => context.read<AddSyllabusBloc>().add(
            UpdateSyllabusClassEvent(val!),
          ),
        );
      },
    );
    ...
    return BlocSelector<AddSyllabusBloc, AddSyllabusState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) => context.read<AddSyllabusBloc>().add(
            UpdateSyllabusSectionEvent(val!),
          ),
        );
      },
    );
    ...
    return BlocSelector<AddSyllabusBloc, AddSyllabusState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) => context.read<AddSyllabusBloc>().add(
            UpdateSyllabusSubjectEvent(val!),
          ),
        );
      },
    );
            ...
            AppDashedUploadButton(
              ...
              onTap: () {
                context.read<AddSyllabusBloc>().add(
                  const UpdateSyllabusPdfUrlEvent(
            ...
            child: BlocSelector<AddSyllabusBloc, AddSyllabusState, bool>(
              ...
              builder: (context, isLoading) {
                return AppPrimaryButton(
                  text: 'SAVE SYLLABUS',
                  isLoading: isLoading,
                  onPressed: () => context.read<AddSyllabusBloc>().add(
                    SubmitSyllabusEvent(),
                  ),
                );
              },
