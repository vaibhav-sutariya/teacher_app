...
import '../student_photo_upload/widgets/photo_upload_bottom_sheet.dart';
...
class ParentPhotoListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ParentPhotoListBloc()
        ..add(LoadParents(className)),
