    ...
    return BlocSelector<AddAssignmentBloc, AddAssignmentState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) =>
              context.read<AddAssignmentBloc>().add(UpdateClassEvent(val!)),
        );
      },
    );
  }
    ...
    return BlocSelector<AddAssignmentBloc, AddAssignmentState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) =>
              context.read<AddAssignmentBloc>().add(UpdateSectionEvent(val!)),
        );
      },
    );
  }
    ...
    return BlocSelector<AddAssignmentBloc, AddAssignmentState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) =>
              context.read<AddAssignmentBloc>().add(UpdateSubjectEvent(val!)),
        );
      },
    );
  }
    ...
    return BlocSelector<AddAssignmentBloc, AddAssignmentState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) =>
              context.read<AddAssignmentBloc>().add(UpdateLessonEvent(val!)),
        );
      },
    );
  }
    ...
    return BlocSelector<AddAssignmentBloc, AddAssignmentState, String?>(
      ...
      builder: (context, value) {
        return AppDropdownField<String>(
          ...
          itemLabel: (item) => item,
          onChanged: (val) =>
              context.read<AddAssignmentBloc>().add(UpdateTopicEvent(val!)),
        );
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: GestureDetector(
        onTap: () => context.read<AddAssignmentBloc>().add(
          UpdateAttachmentTypeEvent(type),
        ),
        child: Container(
          decoration: BoxDecoration(
            color: isSelected
...
class _DescriptionField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppTextField(
      ...
      onChanged: (val) =>
          context.read<AddAssignmentBloc>().add(UpdateDescriptionEvent(val)),
    );
  }
}
            ...
            children: [
              Row(
                children: [
                  ...
                  Switch(
                    value: isEnabled,
                    onChanged: (val) => context.read<AddAssignmentBloc>().add(
                      ToggleSmsEvent(val),
                    ),
            ...
            child: BlocSelector<AddAssignmentBloc, AddAssignmentState, bool>(
              ...
              builder: (context, isLoading) {
                return AppPrimaryButton(
                  text: 'SUBMIT',
                  isLoading: isLoading,
                  onPressed: () => context.read<AddAssignmentBloc>().add(
