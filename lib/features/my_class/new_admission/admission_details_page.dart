...
import 'bloc/admission_details_bloc/admission_details_bloc.dart';
...
class AdmissionDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AdmissionDetailsBloc()
        ..add(LoadDateAdmissions(date)),
...
class _AdmissionDetailsPageContent extends StatelessWidget {
  ...
  const _AdmissionDetailsPageContent({required this.date, required this.totalCount});
