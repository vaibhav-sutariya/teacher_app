...
class AdmissionStudentListBloc
  ...
  void _onLoadClassAdmissions(
    LoadClassAdmissions event,
    Emitter<AdmissionStudentListState> emit,
  ) async {
    emit(
      state.copyWith(
    ...
    try {
      ...
      final mockStudents = [
        ...
        const AdmissionStudentModel(
          rollNo: '38',
          grNo: '135',
          name: 'BRAHMBHATT VEDANT',
        ),
        const AdmissionStudentModel(
          rollNo: '37',
          grNo: '146',
          name: 'BHAVSAR VYOM AKASH',
        ),
      ];
