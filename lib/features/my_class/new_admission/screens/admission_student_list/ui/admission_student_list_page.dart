...
import '../bloc/admission_student_list_bloc.dart';
import '../../addmission_details_screen/ui/widgets/admission_student_item.dart';
                ...
                >(
                  builder: (context, state) {
                    ...
                    if (state.status == AdmissionStudentListStatus.error) {
                      return Center(
                        child: Text(
                          state.errorMessage ?? 'Error Loading Students',
                        ),
                      );
                    }
