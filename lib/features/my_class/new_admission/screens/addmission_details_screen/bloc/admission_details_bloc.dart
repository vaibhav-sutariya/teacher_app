...
class AdmissionDetailsBloc
    extends Bloc<AdmissionDetailsEvent, AdmissionDetailsState> {
  ...
  void _onLoadDateAdmissions(
    LoadDateAdmissions event,
    Emitter<AdmissionDetailsState> emit,
  ) async {
    emit(
      state.copyWith(
        status: AdmissionDetailsStatus.loading,
    ...
    try {
      ...
      final total = mockClassAdmissions.fold<int>(
        0,
      ...
      emit(
        state.copyWith(
          status: AdmissionDetailsStatus.error,
