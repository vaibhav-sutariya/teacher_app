...
class StudentPhotoListBloc extends Bloc<StudentPhotoListEvent, StudentPhotoListState> {
  ...
  void _onLoadStudents(LoadStudents event, Emitter<StudentPhotoListState> emit) async {
    emit(state.copyWith(status: StudentPhotoListStatus.loading, className: event.className));
    try {
      ...
      emit(state.copyWith(status: StudentPhotoListStatus.error, errorMessage: e.toString()));
    }
  }

  void _onSearchStudents(SearchStudents event, Emitter<StudentPhotoListState> emit) {
  ...
  void _onUpdateStudentPhoto(UpdateStudentPhoto event, Emitter<StudentPhotoListState> emit) {
