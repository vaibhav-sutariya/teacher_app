...
import 'bloc/student_photo_list_bloc/student_photo_list_bloc.dart';
...
class StudentPhotoListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => StudentPhotoListBloc()
        ..add(LoadStudents(className)),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.arrow_drop_down, color: Colors.white, size: context.scale(20)),
              ],
            ),
          ),
        ],
