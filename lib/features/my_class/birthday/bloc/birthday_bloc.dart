...
class BirthdayBloc extends Bloc<BirthdayEvent, BirthdayState> {
  ...
  void _onLoadBirthdays(LoadMonthBirthdays event, Emitter<BirthdayState> emit) async {
    ...
    try {
      ...
      emit(state.copyWith(status: BirthdayStatus.error, errorMessage: e.toString()));
    }
  }
