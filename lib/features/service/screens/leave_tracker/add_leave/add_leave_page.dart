...
import 'package:teachers_app/core/widgets/app_dropdown_field.dart';
          ...
          child: IntrinsicHeight(
            child: Row(
              children: [
                Expanded(
                  child: InkWell(
                    onTap: () => context.read<AddLeaveBloc>().add(
                      const FileTypeChanged(true),
                    ),
                    child: Container(
