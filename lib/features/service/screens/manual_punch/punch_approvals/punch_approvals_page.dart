...
import 'package:teachers_app/core/widgets/app_outlined_button.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        appBar: const AppAppBar(title: 'Punch Approvals'),
        body: Column(
          children: [
            // Tabs
            BlocSelector<PunchApprovalsBloc, PunchApprovalsState, int>(
              ...
              builder: (context, selectedIndex) {
                return AppTabBar(
                  ...
                  onTabChanged: (index) {
                    context.read<PunchApprovalsBloc>().add(
                      ChangePunchApprovalTab(index),
                    );
                  },
                );
              },
...
class _PunchApprovalCard extends StatelessWidget {
  ...
  const _PunchApprovalCard({required this.item, required this.isPending});
