...
class PunchTrackerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PunchTrackerBloc()..add(LoadPunchData(DateTime.now())),
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            BlocSelector<PunchTrackerBloc, PunchTrackerState, Map<String, dynamic>>(
              selector: (state) {
                if (state is PunchTrackerLoaded) {
                  return {
              ...
              builder: (context, data) {
                ...
                return MonthCalendar(
                  ...
                  onMonthChanged: (newMonth) {
                    context.read<PunchTrackerBloc>().add(LoadPunchData(newMonth));
                  },
                );
              },
            ),
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: (isPunchIn ? Colors.blue : Colors.orange).withOpacity(0.1),
